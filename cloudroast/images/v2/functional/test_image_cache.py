...
# Test to make sure that image caching is enabled
# Find the directory where the images should be cached
# Load an image and make sure it is put there
# (Test cleanup)
# (Test pruning)


# @unittest.skipUnless(allow_post_images, 'Endpoint has incorrect access')
class TestImageCache(ImagesFixture):
